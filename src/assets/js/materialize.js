    ...
    function(a) {
            ...
            var v = t.CSS = {
                ...
                setPropertyValue: function(a, c, d, e, f) {
                    ...
                    if ("scroll" === c) f.container ? f.container["scroll" + f.direction] = d : "Left" === f.direction ? b.scrollTo(d, f.alternateValue) : b.scrollTo(f.alternateValue, d);
                        ...
                        h = "transform", d = g(a).transformCache[c];
                    else {
                        if (v.Hooks.registered[c]) {
                            var i = c,
                                j = v.Hooks.getRoot(c);
        ...
        function g(a, b, c) {
            ...
            if (a)
                ...
                for (e = 0; e < a.length;) b.call(c, a[e], e, a),
                    e++;
            else
            ...
            this.each(function() {
                ...
                function e() {
                    ...
                    if (e + i.innerWidth() > a(window).width() ? f = "right" : e - i.innerWidth() + g.innerWidth() < 0 && (f = "left"),
                        "left" === f) c = h.gutter, leftPosition = g.position().left + c;
                    else if ("right" === f) {
        ...
        c.prototype.set = function(a, b, c) {
            ...
            if ((!d || !d.nav) && (!m && j.disabled(c) || m && j.disabled(c) && (p || e || g) || !m && (c.pick <= n.pick || c.pick >= o.pick)))
                for (m && !p && (!g && l > 0 || !e && 0 > l) && (l *= -1); j.disabled(c) && (Math.abs(l) > 1 && (c.month < k.month || c.month > k.month) && (c = k,
                        ...
                        l = -1, c = j.create([o.year, o.month, o.date + (c.pick === o.pick ? 0 : 1)])), !h || !i);) c = j.create([c.year, c.month, c.date + l]);
            return c;
